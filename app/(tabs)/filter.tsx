...
import { ActivityIndicator, Alert, Button, SafeAreaView, ScrollView, StyleSheet, Text, View, useColorScheme } from 'react-native';
...
import { RFPercentage } from "react-native-responsive-fontsize";
  ...
  const Filter: React.FC = () => {
    ...
    const resetFilter = () => {
      Alert.alert(
        "Filter zurücksetzen",
        "Möchten Sie wirklich Ihren Filter zurücksetzen?",
        [
          ...
          { 
            ...
            onPress: async () => {
              setMarkedCourses([]);
              if (globalUsername) {
                await AsyncStorage.removeItem(`markedCourses${globalUsername.toLowerCase()}`);
              }
            } 
          }
        ],
